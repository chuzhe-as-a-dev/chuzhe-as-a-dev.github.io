...
permalink: /
subtitle: >
  <span class="contact-email-wrap"><button type="button" class="contact-email" aria-expanded="false" aria-controls="contact-email-popover">Email</button><span id="contact-email-popover" class="contact-email-popover" hidden>chuzhe DOT tang AT epfl DOT ch</span></span> |
